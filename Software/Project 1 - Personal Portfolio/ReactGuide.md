...
```javascript
import './App.css';
import profilePhoto from './profile.jpg'; // Make sure you have this file!
        ...
        <section className="about" id="about">
          ...
          <div className="about-content">
            ...
            <div>
              ...
              <p>
                I specialize in front-end development with React, but I also enjoy 
                working with backend technologies. In my free time, I enjoy hiking, 
...
export default App;
                href="https://github.com/janedoe/weather-dashboard" 
                target="_blank" 
                rel="noopener noreferrer"
                className="project-link"
              >
            ...
            <p>
              A React application that displays real-time weather data for 
              multiple cities. Uses OpenWeather API and includes 5-day forecasts, 
              hourly breakdowns, and weather alerts.
            </p>
            <p className="tech-stack">
              <strong>Technologies:</strong> React, OpenWeather API, Chart.js, CSS
            </p>
          </div>
          ...
          <div className="project-item">
            <h3>
              <a 
                href="https://github.com/janedoe/task-manager" 
                target="_blank" 
                rel="noopener noreferrer"
                className="project-link"
              >
            ...
            <p>
              A full-stack to-do list application built with React and Node.js. 
              Features include user authentication, priority levels, due dates, 
              and cloud storage using MongoDB.
            </p>
            <p className="tech-stack">
              <strong>Technologies:</strong> React, Node.js, Express, MongoDB, JWT
            </p>
          </div>
          ...
          <div className="project-item">
            <h3>
              <a 
                href="https://github.com/janedoe/recipe-finder" 
                target="_blank" 
                rel="noopener noreferrer"
                className="project-link"
              >
            ...
            <p>
              A web app that helps users find recipes based on ingredients they 
              have at home. Integrates with Spoonacular API and includes 
              nutritional information and cooking instructions.
            </p>
            <p className="tech-stack">
              <strong>Technologies:</strong> React, Spoonacular API, Local Storage
            </p>
          </div>
        </section>
        ...
        <section className="experience" id="experience">
          ...
          <div className="experience-item">
            ...
            <p>
              Developed new features for the company's web platform using React 
              and Python. Collaborated with a team of 5 engineers using Agile 
              methodology. Improved page load times by 30% through code optimization.
            </p>
          </div>
          ...
          <div className="experience-item">
            ...
            <p className="company">State University | Fall 2023 - Present</p>
            <p>
              Assist in teaching Introduction to Programming (CS 101). Hold office 
              hours twice weekly and grade assignments for a class of 50 students. 
              Created supplementary learning materials that improved average test scores by 15%.
            </p>
          </div>

          <div className="experience-item">
            <h3>Freelance Web Developer</h3>
            <p className="company">Self-Employed | January 2023 - Present</p>
            <p>
              Build custom websites for small businesses and non-profits. 
              Completed 8 projects ranging from simple landing pages to 
        ...
        <section className="involvement" id="involvement">
          ...
          <div className="involvement-item">
            <h3>President, Computer Science Club</h3>
            <p className="company">State University | 2023 - Present</p>
            <p>
              Lead a team of 10 officers in organizing workshops, hackathons, and 
              social events. Grew membership from 20 to 80 students in one year. 
              Secured $5,000 in sponsorships for annual hackathon.
            </p>
          </div>

          <div className="involvement-item">
            <h3>Volunteer Coding Instructor</h3>
            <p className="company">Code for Good | 2022 - Present</p>
            <p>
              Teach basic programming concepts to high school students from 
              underserved communities. Dedicate 4 hours per week to instruction 
              and curriculum development.
            </p>
          </div>

          <div className="involvement-item">
            <h3>Member, Women in Computing</h3>
            <p className="company">State University | 2022 - Present</p>
            <p>
              Participate in mentorship programs and technical workshops. 
